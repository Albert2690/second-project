...
<div style={{ display: 'flex', alignItems: 'center' }}>
        ...
        <select onChange={(e)=>handleFilter(e.target.value)}
            ...
            >
              ...
              <option className='text-black font-semibold text-md' value="Surgeon">Surgeon</option>
              <option className='text-black font-semibold text-md' value="Orthology">Ortho</option>
